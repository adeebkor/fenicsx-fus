...
from models import WesterveltEquispaced, WesterveltGLL
...
eqn_eq = WesterveltEquispaced(mesh, mt, degree, c0, f0, p0, delta, beta, rho0)
...
eqn_gll = WesterveltGLL(mesh, mt, degree, c0, f0, p0, delta, beta, rho0,
                        vectorised=True)
...
plt.savefig("westervelt_1d_p{}_epw{}.png".format(degree, epw))
