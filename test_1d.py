...
class Model1:
    ...
    def __init__(self, mesh, degree, c0, freq0, p0):
...
class Model3:
    ...
    def __init__(self, mesh, degree, c0, freq0, p0, delta, beta, rho0):
        # Locate boundary facets
        tdim = mesh.topology.dim
...
# Instantiate model
if model == "Model 1":
    eqn = Model1(mesh, degree, c0, f0, p0)
if model == "Model 3":
    eqn = Model3(mesh, degree, c0, f0, p0, delta, beta, rho0)
...
PETSc.Sys.syncPrint("Total step:", nstep)
