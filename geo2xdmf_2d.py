...
gmsh_line = perm_gmsh(cpp.mesh.CellType.interval, 2)
marked_facets = marked_facets[:, gmsh_line]
...
with XDMFFile(MPI.COMM_WORLD, "hifu_mesh_2d.xdmf", "w") as file:
