...
int main(int argc, char* argv[])
{
...

  {
    ...
    io::XDMFFile fmesh(MPI_COMM_WORLD, "/home/mabm4/rds/hpc-work/mesh/transducer_3d_7/mesh.xdmf", "r");
    ...
    // const double finalTime = 0.03 / speedOfSoundWater + 8.0 / sourceFrequency;
    // const double finalTime = 2000 * timeStepSize;
