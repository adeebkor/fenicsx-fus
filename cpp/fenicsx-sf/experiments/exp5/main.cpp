//
// Lossy solver for the 3D planar problem in heterogenous domain
// =============================================================
// Copyright (C) 2022 Adeeb Arif Kor

#include "LossyGLLHeterogenous.hpp"
...
int main(int argc, char* argv[]) {
  ...
  PetscInitialize(&argc, &argv, nullptr, nullptr);
  {
    ...
    instantiation.start();
    auto eqn = LossyGLLHeterogenous<degreeOfBasis>(mesh, mt_cells, mt_facets, 
