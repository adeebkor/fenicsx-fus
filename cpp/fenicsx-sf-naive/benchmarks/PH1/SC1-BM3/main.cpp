...
int main(int argc, char* argv[]) {
...

  {
    ...
    io::XDMFFile fmesh(MPI_COMM_WORLD,
                       "/home/mabm4/rds/hpc-work/mesh/PH1/transducer_3d_5/mesh.xdmf", "r");
    ...
    auto mt_cell = std::make_shared<mesh::MeshTags<std::int32_t>>(
        fmesh.read_meshtags(*mesh, "transducer_3d_5_cells"));
    auto mt_facet = std::make_shared<mesh::MeshTags<std::int32_t>>(
        fmesh.read_meshtags(*mesh, "transducer_3d_5_facets"));
