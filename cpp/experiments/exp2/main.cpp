...
int main(int argc, char* argv[]) {
  ...
  PetscInitialize(&argc, &argv, nullptr, nullptr);
  {
    ...
    auto mesh
        = std::make_shared<mesh::Mesh>(xdmf.read_mesh(element, mesh::GhostMode::none, "planar3d_penetrable"));
    ...
    instantiation.start();
    auto eqn = LinearGLLPenetrable<degreeOfBasis>(mesh, mt_cells, mt_facets, 
    speedOfSoundWater, speedOfSoundBone, sourceFrequency, pressureAmplitude);
    instantiation.stop();
