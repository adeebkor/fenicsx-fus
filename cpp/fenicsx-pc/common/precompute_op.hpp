...
namespace mass {
  ...
  inline void transform(T* __restrict__ detJ, T* __restrict__ phi, 
                        T __restrict__ coeff, T* __restrict__ in, T* __restrict__ out) {
...
namespace stiffness {
  template <typename T, int Nd, int Nq>
  inline void transform2(T* __restrict__ G, T* __restrict__ dphi,
                        T __restrict__ coeff, T* __restrict__ in, 
                        T* __restrict__ out)
  {
    for (int iq = 0; iq < Nq; ++iq) {
  ...
  template <typename T, int Nd, int Nq>
  inline void transform3(T* __restrict__ G, T* __restrict__ dphi,
                         T __restrict__ coeff, T* __restrict__ in,
                         T* __restrict__ out)
  {
    for (int iq = 0; iq < Nq; ++iq) {
