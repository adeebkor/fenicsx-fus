...
public:
  Lossy2D(std::shared_ptr<mesh::Mesh> Mesh, std::shared_ptr<mesh::MeshTags<std::int32_t>> FacetTags,
    ...
    // Define operators
    lin_op = std::make_shared<Stiffness2D<T, P, Q>>(V);
    att_op = std::make_shared<Stiffness2D<T, P, Q>>(V);
...
private:
  ...
  // Operators
  std::shared_ptr<Stiffness2D<T, P, Q>> lin_op, att_op;
...
public:
  Lossy3D(std::shared_ptr<mesh::Mesh> Mesh, std::shared_ptr<mesh::MeshTags<std::int32_t>> FacetTags,
    ...
    // Define operators
    lin_op = std::make_shared<Stiffness3D<T, P, Q>>(V);
    att_op = std::make_shared<Stiffness3D<T, P, Q>>(V);
...
private:
  ...
  // Operators
  std::shared_ptr<Stiffness3D<T, P, Q>> lin_op, att_op;
