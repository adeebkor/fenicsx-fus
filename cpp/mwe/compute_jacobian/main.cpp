...
using mdspan4_t = MDSPAN_IMPL_STANDARD_NAMESPACE::mdspan<T, MDSPAN_IMPL_STANDARD_NAMESPACE::dextents<std::size_t, 4>>;
...
int main(int argc, char* argv[])
{
    ...
    PetscInitialize(&argc, &argv, nullptr, nullptr);
    {
        ...
        // auto [points, weights]
        //   = basix::quadrature::make_quadrature<T>(
        ...
        std::vector<T> J_b(nc * nq * tdim * gdim);
